<div class="modal-content bg-white dark:bg-gray-800 w-full p-4 rounded shadow-lg">
	<div class="flex w-full justify-between mb-4">
		<h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ \Str::ucfirst(__('shift.modal_present_title')) }}</h2>
	...
	<p class=" text-gray-700 dark:text-gray-300">{{ \Str::ucfirst(__('shift.modal_present_text', ['name' => $user->name, 'surname' => $user->surname])) }}</p>
