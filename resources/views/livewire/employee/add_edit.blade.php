				...
				<form wire:submit="store" class="flex flex-col gap-8">
					...
					<div class="w-full flex flex-row gap-9">
						<div class="w-1/2">
							...
							@else
								<x-inputs.password wire:model="password" label="{{ \Str::ucfirst(__('employee.password')) }}" placeholder="{{ __('employee.placeholder_password') }}" />
							@endif
						</div>
						<div class="w-1/2">
							@if(!$employee)
							...
							@else
								<x-inputs.password wire:model="password_confirmation" label="{{ \Str::ucfirst(__('employee.password_confirmation')) }}" placeholder="{{ __('employee.placeholder_password') }}" />
							@endif
						</div>
					</div>
