...
class ThemeTable extends Tailwind
{
    ...
    public function table(): Table
    {
        return Theme::table('min-w-full dark:bg-slate-800')
            ->div('mt-3 rounded-lg relative border border-pg-primary-200 dark:bg-pg-primary-700 dark:border-pg-primary-600')
