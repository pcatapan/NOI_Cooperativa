			...
			<tbody>
				@foreach ($presences as $presence)
					<tr>
						...
						<td class="dark:text-gray-300">{{ $presence['date'] }}</td>
		...
		<div class="md:hidden flex flex-col space-y-2">
			@foreach ($presences as $presence)
				<div class="bg-white dark:bg-gray-800 rounded p-2 shadow flex flex-col">
					<div class="text-sm dark:text-white flex justify-between">Impianto: <span class="dark:text-gray-300">{{ $presence['worksite'] }}</span></div>
